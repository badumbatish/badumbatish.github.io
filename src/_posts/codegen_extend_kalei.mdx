...
A very very smart CS person in my compiler class at UC Berkeley (where i once studied) once told me something along
the line of  "use your tool
very well" or "build your tools" and I feel like
I want to share it in this blog. The use case of when he told me might be different
, but the principle will still remain.

Regardless if it's about the compiler, terminal tool, docker, ci/cd or text editors such as neovim,
vscode, helix, it really pays off to learn how to use your tool so good that it
