...
as well as my perspective on each interview round, have been written since December 2024.
I hope
everyone enjoys :)
...
leetcode on the daily throughout the timeline to get back into the game; by the time the pre-December period ends, I
...
Interviewing with a lot of stray companies made me more indifferent, more efficient and better at
...
It is important to improve and advocate for yourself, especially in an over-saturated market, whether it is through
your projects,
resume or
general marketing. I can't stress that fact enough; please never forget that.
...
followed next was a rejection. The recruiter thankfully gave me a very helpful feedback: "you have some of the
skills we're looking for, but it's not there yet."
### Takoyaki
...
"compiler" or "programming languages,", they're gonna ask, in detail, each line that I wrote in the resume.
...
for documentation.
- "what, to your knowledge, might be a difference in a compiler's AST and HIR?"
...
outside professional experience that speaks to this aspect?"
...
with
spelling out numbers. I'm a transgender woman of color, who for every 2-4 months, has to take blood tests of
for $200. A
...
Every journey is messy and unique, tangled with each person's upbringing,
