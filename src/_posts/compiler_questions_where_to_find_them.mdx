...
date: 2025-4-17
recap: "Jasmine helps new grad in compiler by sharing interview questions through her new grad recruiting journey"
---
...
- How do we make sure we don't waste time computing the combination sums that doesn't have an answer?
...
- Why is hardware important for faster inference of machine learning models?
...
Interviewer asked me to implement the naive approach. Then moved on to ask me how I would test them and asked me
...
We moved on to talk about if-else type checking. They asked me to give actual pseudocode that type checks an
...
This company features the most interactive and problem-solving aspect in the whole line up, exceeding just a bit
...
teamwork the team has displayed to me during my interview made me stand in awe. They really took me back in my
...
our school's upper divisions in software-hardware architecture, the question on lowering assembly would have been easier.

The interview process with the company had ignited my drive to work harder to better myself. Needless to say, what
...
![eecs_1](/blogs/compiler_questions_where_to_find_them/eecs1.jpg)
![eecs_2](/blogs/compiler_questions_where_to_find_them/eecs2.jpg)
![eecs_3](/blogs/compiler_questions_where_to_find_them/eecs3.jpg)
