...
music:
  - title: "Iris"
    ...
    youtubeId: "UfvULU7lx4w"
    commentary: "Both give my heart this feeling that summer is coming through soon; that the heat of youth will strive again and that I'll be on the beach again :)"
  - title: "Strawberry Sunscreen"
    artist: "Lostboycrow"
    youtubeId: "eUCHyIfgnag"
---
...
For transparency, the résumé that I used for the recruiting cycle is
[here](/blogs/compiler_questions_where_to_find_them/jas_recruit_2025.pdf).
Here is my [GitHub](https://github.com/badumbatish) and [leetcode](https://leetcode.com/u/badumbatish/).
...
from $n_1=500$ to
$n_2=1000$, does it imply that my implementation is $O(n^2)$?"
...
like $f(3) = f(2) + f(1) = 2(f1) + f(0)$ and test each of them despite me not knowing
how to
...
The Takoyaki was also one of the few companies that scores really high in respect their transparency. They clearly set the
...
Again, to potential interviewers, if your interview questions are pre-determined by your hiring manager or company
policy, I hope
...
also for
your own
sake, lest you risk hiring someone who can only solve leetcode instead of a true junior compiler engineer.
...
Below shows a Sankey graph of my progress.
![stats_1](/blogs/compiler_questions_where_to_find_them/stats_1.png)

You'll find it interesting (or not hahah) that all of my success leading into phone screen/interview didn't go
through online assessments; none of my attempts in OA got me through the next round.

One point of insight is that mass/cold applying to every role on the internet didn't lead to much: applying within
my area of specialization seemed to yield much better results.

There was no résumé customization for each job; I submitted to all jobs using the same one.

I should also note that for 15 phone screen/interview, there were
- 8 companies doing AI/GPU compiler.
- 5 companies doing traditional compiler work.
- 2 companies doing quantum computing compiler.

As a new grad who has limited knowledge in AI/GPU, the odds were somewhat stacked against me: companies seemed to
want AI/GPU as the main driver, with compiler knowledge on the side.

There were 5 companies (with their job postings) that promote open source work.

In total, 6 companies were Big Tech. 2 were
consultancies, and the rest were startups.

Another point of interest is that for all companies that I've gotten into phone screen/interview, there were 2 job
applications explicitly gearing towards new grads; the rest is generic in that everybody can apply for them, forcing
new grads to have the same competitive edge as working professionals.
...
[Kofi](https://ko-fi.com/badumbatish) or [LinkedIn](https://www.linkedin.com/in/jjasmine-t/). I'd love to recieve your
support via [kofi.com/badumbatish](https://ko-fi.com/badumbatish)
