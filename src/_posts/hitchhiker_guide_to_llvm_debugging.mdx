...
Personally, I'm very thankful for both the open source community and my colleagues at Igalia for guiding me on my path of learning LLVM.
It would be treacherous and nigh-impossible without them :)

# Epilogue

Welp, that's it for this blog :) In writing this blog, I hope that the article will act as follows. For newcomers, the article will
