...
As of Monday, August 11, 2025, here is the comparison from the LLVM LLD page, with the percentage difference when compared to the GNU's ld linker:

| Program       | Output size | GNU ld (time) | GNU gold (time) | lld (time) |
|---------------|-------------|-------------------------|----------------------------|------------|
